...
CREATE TABLE tbl_employer(
    ...
    cpf_employer	CHAR(11)     NOT NULL,
    phone_employer	CHAR(13)	 NOT NULL,
    email_employer	VARCHAR(80)  NOT NULL,
...
CREATE TABLE tbl_airport(
    ...
    city_airport	 VARCHAR(30)  NOT NULL,
...
CREATE TABLE tbl_ticket(
	...
	FOREIGN KEY(fk_flight) 	    	 REFERENCES tbl_flight(pk_IDflight)    
);
